...
function displayPaths(paths) {
    const container = document.getElementById('api-paths') || createContainer('api-paths', 'API Endpoints');
    ...
    // Add control buttons before the paths
    const controlsHtml = `
    ...
    let pathsHtml = controlsHtml + '<div class="paths-container">';
